package NKTI::general::dbms::pgsql;
...
# Subroutine for Error Handling PostgreSQL Connection :
# ------------------------------------------------------------------------
=head1 SUBROUTINE errconn()
    
    Deskripsi subroutine errcon() :
    ----------------------------------------  
    Subroutine yang berfungsi untuk Handel Error Connection PostgreSQL.
...
# End of Subroutine for Error Handling PostgreSQL Connection.
# ===========================================================================================================

# Subroutine for Error Handling data PostgreSQL Connection :
# ------------------------------------------------------------------------
=head1 SUBROUTINE errdata()
    
    Deskripsi subroutine errdata() :
    ----------------------------------------
    Subroutine yang berfungsi untuk menampilkan error saat proses koneksi Data PostgreSQL.
...
# End of Subroutine for Error Handling data PostgreSQL Connection.
# ===========================================================================================================
...
=head1 COPYRIGHT AND LICENSE
    ...
    Pustaka yang berfungsi untuk database postgresql.
=cut